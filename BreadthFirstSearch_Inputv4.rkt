 #lang racket
  (define input(list "ail" "lee" "aim" "and" "ark" "ape" "fit" "auk" "tie" "boa" "add" "fat" "far" "awl" "bag" "ago" "ash" "rat" "art" "aid" "are" "age" "bat" "air" "ask" "awe" "any" "oaf" "eft" "tar" "bee" "ban" "apt" "eel" "ear" "arc" "ado" "aye" "arm" "bad"))
